$(document).ready(function () {
    ...
    let isNoHeader = document.querySelector('.service-hero') ?? document.querySelector('.project-hero');
    ...
    navItems.forEach(function (item) {
        ...
        if (dropdown) {
            item.addEventListener('click', function () {
                if (item.parentElement.querySelector('.navbar-dropdown').classList.contains('active')) {
    ...
    dropdowns.forEach(function (dropdown) {
        dropdown.querySelector('button').addEventListener('click', function () {
            if (dropdown.querySelector('.desktop-modal').classList.contains('active')) {
    ...
    document.querySelectorAll('.navbar-dropdown .arrow').forEach(function (arrow) {
    ...
    document.querySelectorAll('.navbar-dropdown .cancel').forEach(function (cancel) {
    ...
    $(".overlay").on('click', function () {
        document.querySelectorAll('.navbar-dropdown, .lang-dropdown').forEach(function (item) {
    ...
    if (articleH1) {
        if (document.querySelector('.article-hero h1').innerText.length > 40) {
            document.querySelector('.article-hero h1').style.fontSize = isMobile ? '1.375rem' : '3.5rem';
        }
    }
    ...
    if (calendarDays) {
        ...
        function renderCalendar(date) {
            ...
            monthYear.textContent = date.toLocaleString('en-EN', { month: 'long', year: 'numeric' });
            ...
            for (let day = 1; day <= daysInMonth; day++) {
                ...
                const isBeforeToday = thisDate < new Date(today.getFullYear(), today.getMonth(), today.getDate());
